...
![alt text](./images/weird-behaviour-view-controller/before-go-background.PNG =320x480)

After go from Background
![alt text](./images/weird-behaviour-view-controller/after-go-from-background.PNG =320x480)
